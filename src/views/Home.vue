            ...
            <div class="space-y-16">
                <div v-for="exp in experiences" :key="exp.title" class="group">
                    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 mb-3">
                        <h3
                            class="text-xl font-normal text-slate-800 dark:text-slate-100"
                        >
                            {{ exp.title }}
                        </h3>
                        <span class="text-xs text-slate-400 dark:text-slate-500 font-mono">{{ exp.period }}</span>
                    </div>
                    <p
                        class="text-slate-600 dark:text-slate-300 mb-4 font-medium text-sm"
                    >
                        {{ exp.company }}
                    </p>
                    <ul
                        class="space-y-2.5 text-slate-600 dark:text-slate-300 text-sm leading-relaxed"
                    >
                    ...
                    <div v-if="exp.recommendation" class="mt-6 pt-6 border-t border-slate-100 dark:border-slate-800/60">
                        <a
